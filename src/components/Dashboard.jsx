        ...
        <motion.section variants={itemVariants}>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="text-[15px] font-semibold" style={{ color: 'var(--text-primary)' }}>Devotional</p>
              <p className="text-[13px] mt-0.5" style={{ color: 'var(--text-tertiary)' }}>Scripture & journal</p>
            </motion.button>
